...
| [ADR-003](ADR-003-ssr.md)                 | SSR in a separate `apps/site`, not in the shell (spike result)     | Accepted |
...
| [ADR-013](ADR-013-ios-bundled-remotes.md) | The iPhone app ships the quiz remotes inside its bundle            | Accepted |
