...
| `shell`             | Greeting rule; progress store derivations; tabs, Home, Leaderboard, Achievements, Settings pages in English and Russian with real providers                                                                                                                                                                                                                                | Component + integration                  |
| `capitals`, `flags` | Root component renders                                                                                                                                                                                                                                                                                                                                                     | Component (placeholder)                  |
| `shell-e2e`         | Home with real totals; tab navigation; deep links and unknown routes; system vs explicit theme across reloads; switching to Russian and persistence; bundled flag assets                                                                                                                                                                                                   | E2E                                      |
...
Ionic components run in jsdom; `apps/shell/src/testing/test-setup.ts` adds the
missing `matchMedia` and `Element.scrollTo`, and tests dispatch `ionChange`
as a DOM event.
