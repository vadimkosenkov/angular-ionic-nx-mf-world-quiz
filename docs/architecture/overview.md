...
| 8a  | `feat/sync-server`           | A player's history for sync (`GET /v1/sessions`, keyset pages) — API                   | ✅ this branch |
| 8b  | `feat/sync-client`           | Sign-in first, local store (IndexedDB), outbox, sync                                   | 📐             |
