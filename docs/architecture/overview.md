...
| 9a  | `feat/leaderboard-server`    | Challenges with a server seed, ranked runs, public boards, records, nicknames — API    | ✅ this branch |
| 9b  | `feat/leaderboard-client`    | Challenges and the leaderboard screen in the app                                       | 📐             |
| 9c  | `feat/site-ssr`              | `apps/site` SSR: legal pages, public leaderboard; SSR-in-shell spike, ADR-003          | 📐             |
