...
export class SyncApi {
  ...
  /** Records a session; a retry of the same request is answered 200. */
  async submit(request: SubmitSessionRequest): Promise<void> {
    await firstValueFrom(this.http.post(`${this.apiUrl}/v1/sessions`, request));
  }
