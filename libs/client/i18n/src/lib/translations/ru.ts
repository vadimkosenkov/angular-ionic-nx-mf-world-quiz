...
export const ru: TranslationShape = {
  ...
  settings: {
    ...
    account: {
      ...
      intro:
        'Войдите, чтобы создать аккаунт World Quiz. Синхронизация прогресса между устройствами появится в следующем обновлении.',
      googleUnavailable:
      ...
      syncLater:
        'Пока результаты хранятся на этом устройстве; сохранение в аккаунт появится в следующем обновлении.',
      signOut: 'Выйти',
