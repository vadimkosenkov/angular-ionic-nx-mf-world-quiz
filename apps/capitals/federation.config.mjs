...
export default withNativeFederation({
  ...
  // The remote exposes its route configuration. The shell mounts it with
  // `loadChildren`, so navigation, guards and lazy loading keep working
  // across the microfrontend boundary.
  exposes: {
    './routes': './apps/capitals/src/app/remote.routes.ts',
  },
